...
class Doit_Easynfe_Adminhtml_EasynfeController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function saveAction(){
        $this->_initRequest();
        $nfId = Mage::getModel('doit_easynfe/sales_order_request')->load( Mage::registry('nfe_data')->getId() )->getNfeNfId();
        $orderId = Mage::getModel('doit_easynfe/sales_order')->load( Mage::getModel('doit_easynfe/sales_order_nf')->load( $nfId )->getNfOrderId() )->getOrderId();
